...
page_views_idx = persist(zip_index(page_views, 'document_id', 'document_idx'))
...
def transform_dataset_to_df(df):
    return (transform_dataset(df).toDF()
            .toDF('display_id', 'ad_id', 'label', 'features'))
